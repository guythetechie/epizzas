...
public sealed record OrderId
{
    ...
    public static JsonNode Serialize(OrderId orderId) =>
...
public sealed record Order
{
    ...
    public static JsonResult<Order> Deserialize(JsonNode? json)
    {
        return from jsonObject in json.AsJsonObject()
               let orderResult = deserializeOrderId(jsonObject)
               let statusResult = deserializeStatus(jsonObject)
               let pizzasResult = deserializePizzas(jsonObject)
               from order in (orderResult, statusResult, pizzasResult)
        ...
        static JsonResult<ImmutableArray<Pizza>> deserializePizzas(JsonObject json) =>
            ...
            from pizzaJsonObjects in pizzasJsonArray.AsIterable()
                                                    .Traverse(JsonNodeModule.AsJsonObject)
                                                    .As()
            from pizzas in from pizzas in pizzaJsonObjects.Traverse(Pizza.Deserialize)
                                                          .As()
